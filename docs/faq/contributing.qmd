...
Both will be automatically indexed when the site is deployed. The documentation is deployed using [Quarto](https://quarto.org), and the documentation is built from the `./docs/` directory. Please fork or clone [](https://github.com/UCLH-Foundry/Garden-Path).
