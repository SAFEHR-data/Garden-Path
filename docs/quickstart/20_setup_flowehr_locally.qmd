...
Repositories:
1. [FlowEHR-Data-Sources](https://github.com/UCLH-Foundry/FlowEHR-Data-Sources) - fork or clone this repo.
...
3. [VM-Image-Gallery](https://github.com/UCLH-Foundry/VM-Image-Gallery) - this is a private repo
4. [UCLH-Azure-TRE](https://github.com/UCLH-Foundry/FlowEHR-AzureTRE)  - this is a private repo
5. [Book-of-FlowEHR](https://github.com/UCLH-Foundry/Book-of-FlowEHR/) - this is a private repo

Additional Repositories used:
1. [FlowEHR-Data-Sources](https://github.com/UCLH-Foundry/FlowEHR-Data-Sources) - uses [Inform-DB](https://github.com/inform-health-informatics/Inform-DB/) and [Satellite](https://github.com/UCLH-Foundry/Satellite)
2. [FlowEHR](https://github.com/UCLH-Foundry/FlowEHR) - uses [Data-Forge](https://github.com/UCLH-Foundry/FlowEHR-Data-Forge.git)
3. [Powershell-Scripts](https://github.com/UCLH-Foundry/Powershell-Scripts) - allows VM Customisations of windows VMs

There are also public templates such as [FlowEHR-Data-Pot](https://github.com/UCLH-Foundry/FlowEHR-Data-Pot) (Example data pipeline), [Model-Seedling](https://github.com/UCLH-Foundry/Model-Seedling) (starting point for a new Data Science project) and [Dash-Seedling](https://github.com/UCLH-Foundry/Dash-Seedling) (Dash apps)
...
- [FlowEHR-Data-Sources](https://github.com/UCLH-Foundry/FlowEHR-Data-Sources):
    ...
    N.B. A common error is "ERROR: deleting subnet..." which seems to occur because a subnet already exists that is using the same address space so shouldn't be deleted.
