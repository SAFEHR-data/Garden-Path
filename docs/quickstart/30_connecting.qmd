...
1. We have built a tool ([Satellite](https://github.com/SAFEHR-data/Satellite)) that streams structually correct but semantically meaningless data for the purposes of development.
